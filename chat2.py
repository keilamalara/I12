...
if tecnicatura == "Tecnicatura Superior en Higiene y Seguridad en el Trabajo":
    ...
    tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8 = st.tabs(
        ["Materias Cursadas", "Duración", "Habilidades", "Instituciones", "Salidas Laborales", 
         "Prácticas", "Oportunidades", "Apoyo a Estudiantes"]
    )

    with tab1:
        st.write("**Materias Cursadas**")
        st.write("Incluyen comunicación y administración de medios, higiene laboral y medio ambiente, medicina del trabajo, ergonomía y estadística.")
    ...
    with tab4:
        st.write("**Instituciones Contratantes**")
        st.write("Empresas industriales, de construcción, servicios de salud y organismos gubernamentales.")
    ...
    with tab7:
        st.write("**Oportunidades de Especialización**")
        st.write("Los egresados pueden optar por especializaciones en seguridad e higiene.")

    with tab8:
        st.write("**Apoyo a Estudiantes**")
        st.write("Talleres de desarrollo profesional, ferias de empleo y asesoramiento para la inserción laboral.")
